...
export class SharedDataService {
      ...
      topics: [
        {
          ...
          topic_id: "improvement",
          file_data: {
            bucketname: "app-blob-storage",
            foldername:
              "Agricultural problems in haryana uuid-1234567890-client",
            file_url: "record1581072675083.wav",
            ismono: false
          },
          isUploaded: true
        },
  ...
  updateSessionTopicData(sessionId, topicName, file) {
    ...
    topicData["file_data"]["foldername"] = "files";
    topicData["file_data"]["file_url"] = file;
